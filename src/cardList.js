...
[
    ...
    "plusDebt",                 //Cards that give debt on play, first introduced in Rising Sun
...
const cards = 
{
    ...
    */
     ...
     * RISING SUN
     ***/
    MountainShrine: {cost: -5,  expansion: "risingsun",     edition: "base",    types: ["action", "omen"],                  tags: ["terminal", "virtualCoin", "trasher", "drawer"]},
    Daimyo:         {cost: -6,  expansion: "risingsun",     edition: "base",    types: ["action", "command"],               tags: ["cantrip", "throneRoom"]},
    Artist:         {cost: -8,  expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["drawer"]},
    Fishmonger:     {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["action", "shadow"],                tags: ["terminal", "plusBuy", "virtualCoin"]},
    SnakeWitch:     {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["action", "attack"],                tags: ["cantrip", "curserAttack"]},
    Aristocrat:     {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["conditionalTerminal", "village", "drawer", "virtualCoin", "plusBuy"]},
    Craftsman:      {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["terminal", "plusDebt", "workshop", "gainer"]},
    Riverboat:      {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["action", "duration"],              tags: ["terminal"]}, //TODO No tags for this kind of effect yet
    RootCellar:     {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["cantrip", "drawer", "plusDebt"]},
    Alley:          {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action", "shadow"],                tags: ["cantrip", "sifter", "discarder"]},
    Change:         {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["terminal", "remodel", "trasher", "trashForBenefit", "plusDebt"]},
    Ninja:          {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action", "attack", "shadow"],      tags: ["terminal", "drawer", "handSizeAttack"]},
    Poet:           {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action", "omen"],                  tags: ["cantrip", "drawer", "inspector"]},
    RiverShrine:    {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action", "omen"],                  tags: ["terminal", "trasher", "gainer"]},
    RusticVillage:  {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["action", "omen"],                  tags: ["cantrip", "village", "sifter", "discarder"]},
    GoldMine:       {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["cantrip", "plusBuy", "gainer", "plusDebt"]},
    ImperialEnvoy:  {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["terminal", "drawer", "plusBuy", "plusDebt"]},
    Kitsune:        {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action", "attack", "omen"],        tags: ["conditionalTerminal", "village", "virtualCoin", "curserAttack", "gainer"]},
    Litter:         {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["cantrip", "drawer", "village", "plusDebt"]},
    RiceBroker:     {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action"],                          tags: ["trasher", "drawer"]},
    Ronin:          {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action", "shadow"],                tags: ["terminal", "drawer", "drawToX"]},
    Tanuki:         {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action", "shadow"],                tags: ["terminal", "remodel", "trasher", "trashForBenefit"]},
    TeaHouse:       {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["action", "omen"],                  tags: ["cantrip", "virtualCoin", "peddler"]},
    Samurai:        {cost: 6,   expansion: "risingsun",     edition: "base",    types: ["action", "duration", "attack"],    tags: ["terminal", "handSizeAttack", "virtualCoin", "staysInPlay"]},
    Rice:           {cost: 7,   expansion: "risingsun",     edition: "base",    types: ["treasure"],                        tags: ["plusBuy", "virtualCoin"]},
};
...
const landscapes = 
{
     ...
     * RISING SUN
     ***/
    Continue:       {cost: -8,  expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["gainer"]},
    Amass:          {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["gainer"]},
    Asceticism:     {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["trasher"]},
    Credit:         {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["gainer", "plusDebt"]},
    Foresight:      {cost: 2,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["digger", "discarder", "delayedDrawer"]},
    Kintsugi:       {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["trasher", "remodel", "trashForBenefit"]},
    Practice:       {cost: 3,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["throneRoom"]},
    SeaTrade:       {cost: 4,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["trasher"]},
    ReceiveTribute: {cost: 5,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["gainer"]},
    Gather:         {cost: 7,   expansion: "risingsun",     edition: "base",    types: ["event"],               tags: ["gainer"]},
    
    ApproachingArmy:{cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["virtualCoin"]},
    BidingTime:     {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["delayedDrawer"]},
    ...
    FlourishingTrade:{cost: -99,expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["bridge", "plusBuy"]},
    GoodHarvest:    {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["plusBuy", "virtualCoin"]},
    GreatLeader:    {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["village"]},
    Growth:         {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["gainer"]},
    HarshWinter:    {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["plusDebt"]},
    KindEmperor:    {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["gainer"]},
    Panic:          {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["plusBuy"]},
    Progress:       {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["topDecker"]},
    RapidExpansion: {cost: -99, expansion: "risingsun",     edition: "base",    types: ["prophecy"],            tags: ["setAside"]},
